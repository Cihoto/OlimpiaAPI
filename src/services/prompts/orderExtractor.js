export const  GMAIL_ORDER_ANALYSIS_PROMPT = `Devuelveme exclusivamente un JSON, sin explicaciones ni texto adicional
...
export const GENERAL_ORDER_ANALYSIS_PROMPT= `
